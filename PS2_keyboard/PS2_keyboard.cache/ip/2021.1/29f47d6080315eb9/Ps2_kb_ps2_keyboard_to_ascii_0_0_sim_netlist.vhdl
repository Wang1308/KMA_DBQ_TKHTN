...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ps2_keyboard is
  ...
  attribute SOFT_HLUTNM of \ascii[0]_i_7\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \ascii[2]_i_7\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \ascii[3]_i_7\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \ascii[4]_i_5\ : label is "soft_lutpair11";
  ...
  attribute SOFT_HLUTNM of \ascii[6]_i_1\ : label is "soft_lutpair9";
...
control_l_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FF7F0040"
    )
        port map (
...
control_r_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FF7F0040"
    )
        port map (
...
control_r_i_3: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0004"
    )
        port map (
...
ps2_keyboard_0: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ps2_keyboard
     port map (
      ...
      E(0) => ascii,
      \FSM_sequential_state_reg[1]\ => ps2_keyboard_0_n_18,
