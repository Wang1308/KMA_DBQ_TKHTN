...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ps2_keyboard is
  ...
  attribute SOFT_HLUTNM of \ascii[1]_i_4\ : label is "soft_lutpair14";
  ...
  attribute SOFT_HLUTNM of \ascii[6]_i_15\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \ascii[6]_i_2\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \ascii[6]_i_4\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of break_i_5 : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of control_r_i_3 : label is "soft_lutpair13";
  ...
  attribute SOFT_HLUTNM of shift_l_i_3 : label is "soft_lutpair14";
begin
...
break_i_3: unisim.vcomponents.LUT6
    generic map(
...
break_i_4: unisim.vcomponents.LUT6
    generic map(
...
break_i_5: unisim.vcomponents.LUT3
    generic map(
      INIT => X"06"
    )
        port map (
...
\ascii[7]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I1 => ps2_keyboard_0_n_13,
      I2 => state(0),
      I3 => ps2_keyboard_0_n_10,
      I4 => \ascii_reg_n_0_[7]\,
      O => \ascii[7]_i_1_n_0\
    );
...
ps2_keyboard_0: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ps2_keyboard
     port map (
      ...
      \FSM_sequential_state_reg[0]\ => ps2_keyboard_0_n_9,
      \FSM_sequential_state_reg[0]_0\ => ps2_keyboard_0_n_14,
      \FSM_sequential_state_reg[0]_1\ => ps2_keyboard_0_n_20,
      Q(1) => \FSM_sequential_state_reg_n_0_[1]\,
      Q(0) => state(0),
      ascii(6 downto 0) => ascii(6 downto 0),
      ascii_new => \^ascii_new\,
      ascii_new_reg => \ascii_reg_n_0_[7]\,
      \ascii_reg[7]\ => ps2_keyboard_0_n_19,
      break_reg => ps2_keyboard_0_n_15,
      break_reg_0 => ps2_keyboard_0_n_16,
      break_reg_1 => ps2_keyboard_0_n_17,
      break_reg_2 => ps2_keyboard_0_n_18,
      break_reg_3 => break_reg_n_0,
      caps_lock_reg => caps_lock_reg_n_0,
      clk => clk,
      control_l_reg => ps2_keyboard_0_n_10,
      control_l_reg_0 => control_l_reg_n_0,
      control_r_reg => control_r_reg_n_0,
      e0_code => e0_code,
      e0_code_reg => ps2_keyboard_0_n_1,
      prev_ps2_code_new => prev_ps2_code_new,
      ps2_code_new => ps2_code_new,
      \ps2_code_reg[7]_0\ => ps2_keyboard_0_n_13,
