...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ps2_keyboard is
  ...
  signal caps_lock_i_3_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of caps_lock_i_3 : label is "soft_lutpair12";
...
caps_lock_i_3: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
ps2_keyboard_0: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ps2_keyboard
     port map (
      ...
      \FSM_sequential_state_reg[1]_0\ => break_reg_n_0,
      \FSM_sequential_state_reg[1]_1\ => \FSM_sequential_state_reg_n_0_[1]\,
      ...
      break_reg_5 => ps2_keyboard_0_n_16,
