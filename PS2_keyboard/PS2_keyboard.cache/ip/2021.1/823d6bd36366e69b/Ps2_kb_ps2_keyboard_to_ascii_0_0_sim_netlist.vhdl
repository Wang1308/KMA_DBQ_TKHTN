...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ps2_keyboard is
  ...
  signal break_i_3_n_0 : STD_LOGIC;
  signal break_i_4_n_0 : STD_LOGIC;
  signal break_i_5_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \ascii[4]_i_5\ : label is "soft_lutpair12";
  ...
  attribute SOFT_HLUTNM of break_i_4 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of break_i_5 : label is "soft_lutpair11";
...
break_i_3: unisim.vcomponents.LUT5
    generic map(
      INIT => X"05004848"
    )
        port map (
...
break_i_4: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0004"
    )
        port map (
...
break_i_5: unisim.vcomponents.LUT4
    generic map(
      INIT => X"4000"
    )
        port map (
